...
Python Programlama dersi kapsamında geliştirilen bu proje, bir telekomünikasyon (Telco) şirketi için temel müşteri yönetimi ve analiz sistemi simülasyonu oluşturmayı amaçlamaktadır.

Proje içerisinde Python’un temel programlama yapıları kullanılarak:
- müşteri verilerinin yönetimi,
- fatura hesaplama işlemleri,
- churn (müşteri kaybı) analizi,
- veri organizasyonu,
- otomatik müşteri sınıflandırması
...
✅ Müşteri bilgilerinin Dictionary yapısında saklanması  
✅ Hizmetlerin List ve Set yapıları ile yönetilmesi  
✅ VIP müşteri tespiti  
✅ Random müşteri ID oluşturma  
✅ KDV dahil otomatik fatura hesaplama  
✅ Churn (müşteri ayrılma riski) analizi  
✅ Tarih ve zaman işlemleri  
✅ Python kütüphaneleri kullanımı (`random`, `math`, `datetime`)  
✅ Döngüler ve fonksiyonlarla çoklu müşteri yönetimi  
  ...
  "cells": [
    {
      ...
      "metadata": {
        ...
        "id": "knMC9KQBXgnT",
        "outputId": "78ccd906-fa9a-47f7-b078-b581a7cd7653"
      },
      "outputs": [
        {
          "output_type": "stream",
          ...
          "text": [
            ...
            "Customer ID: IST-2026-3676\n",
            "\n",
            "Müşteri Bilgileri:\n",
            "{'ad_soyad': 'Ahmet Yılmaz', 'aylik_ucret': 650.75, 'sadakat_ayi': 30, 'aktif_mi': True, 'hizmetler': ['İnternet', 'TV+', 'Mobil Hat', 'Bulut Depolama', 'Müşteri Destek Paketi']}\n",
            "\n",
            "===== 2. KISIM =====\n",
            "\n",
            "===== FATURA BİLGİLERİ =====\n",
            "\n",
            "Müşteri Adı: Ahmet\n",
            "KDV Dahil Tutar: 540 TL\n",
            "Churn Riski Var\n",
            "\n",
            "Müşteri Adı: Ayşe\n",
            "KDV Dahil Tutar: 840 TL\n",
            "Müşteri Aktif\n",
            "\n",
            "Müşteri Adı: Mehmet\n",
            "KDV Dahil Tutar: 360 TL\n",
            "Churn Riski Var\n",
            "\n",
            "Müşteri Adı: Zeynep\n",
            "KDV Dahil Tutar: 1080 TL\n",
            "Müşteri Aktif\n",
            "\n",
            "Müşteri Adı: Can\n",
            "KDV Dahil Tutar: 300 TL\n",
            "Churn Riski Var\n",
            "\n",
            "Fatura Tarihi: 11/05/2026\n",
            "\n",
            "Benzersiz Hizmetler:\n",
            "{'TV+', 'Bulut Depolama', 'İnternet', 'Mobil Hat'}\n",
            "\n",
            "===== KRİTİK SORU 1 =====\n",
            "\n",
